...
class Face_Out_Screen extends StatefulWidget {
  const Face_Out_Screen({Key? key}) : super(key: key);
  @override
  _Face_Out_ScreenState createState() => _Face_Out_ScreenState();
}

class _Face_Out_ScreenState extends State<Face_Out_Screen> {
  late final  height;
